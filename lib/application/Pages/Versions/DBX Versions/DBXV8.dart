...
class DBXV8 extends StatefulWidget {
  const DBXV8({super.key});

  @override
  State<DBXV8> createState() => _DBXV8State();
}

class _DBXV8State extends State<DBXV8> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            FutureBuilder(
              future: noticiasF1.doc('DBXV8').get(),
              builder: (context, snapshot) {
                ...
                return Column(
                  children: [
                    ...
                    // Img Auto
                    Image.network(
                      'https://configurator.api-services.astonmartin.com/static/assets/modelselection/am806@3.png',
                    ),
