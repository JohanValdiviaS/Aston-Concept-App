...
class DBX707 extends StatefulWidget {
  const DBX707({super.key});

  @override
  State<DBX707> createState() => _DBX707State();
}

class _DBX707State extends State<DBX707> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            FutureBuilder(
              future: noticiasF1.doc('DBX-707').get(),
              builder: (context, snapshot) {
                ...
                return Column(
                  children: [
                    ...
                    // Img Auto
                    Image.network(
                      'https://configurator.api-services.astonmartin.com/static/assets/modelselection/am886@3.png',
                    ),
