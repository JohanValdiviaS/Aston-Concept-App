...
class AMR21 extends StatefulWidget {
  const AMR21({super.key});

  @override
  State<AMR21> createState() => _AMR21State();
}

class _AMR21State extends State<AMR21> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            FutureBuilder(
              future: noticiasF1.doc('amr21').get(),
              builder: (context, snapshot) {
                ...
                return Column(
                  children: [
                    ...
                    // Img F1
                    Image.network(
                      'https://www.lequipe.fr/special/Formule-1/guide/v5/f1-2021/images/04_aston-martin_car.png',
                      fit: BoxFit.fitWidth,
                    ),
