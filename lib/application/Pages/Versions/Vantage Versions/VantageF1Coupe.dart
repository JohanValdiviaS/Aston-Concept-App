...
class VantageCoupeF1 extends StatefulWidget {
  const VantageCoupeF1({super.key});

  @override
  State<VantageCoupeF1> createState() => _VantageCoupeF1State();
}

class _VantageCoupeF1State extends State<VantageCoupeF1> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            FutureBuilder(
              future: noticiasF1.doc('VantageCoupeF1').get(),
              builder: (context, snapshot) {
                ...
                return Column(
                  children: [
                    ...
                    // Img Auto
                    Image.network(
                      'https://configurator.api-services.astonmartin.com/static/assets/modelselection/am608f@3.png',
                    ),
