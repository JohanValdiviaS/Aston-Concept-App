...
class VantageV12Coupe extends StatefulWidget {
  const VantageV12Coupe({super.key});

  @override
  State<VantageV12Coupe> createState() => _VantageV12CoupeState();
}

class _VantageV12CoupeState extends State<VantageV12Coupe> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            FutureBuilder(
              future: noticiasF1.doc('VantageV12Coupe').get(),
                ...
                return SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      // Img Auto
                      Image.network(
                        'https://configurator.api-services.astonmartin.com/static/assets/modelselection/am688@3.png',
                      ),
