...
class VantageV12Roadster extends StatefulWidget {
  const VantageV12Roadster({super.key});

  @override
  State<VantageV12Roadster> createState() => _VantageV12RoadsterState();
}

class _VantageV12RoadsterState extends State<VantageV12Roadster> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            FutureBuilder(
              future: noticiasF1.doc('VantageV12Roadster').get(),
                ...
                return SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      // Img Auto
                      Image.network(
                        'https://configurator.api-services.astonmartin.com/static/assets/modelselection/am668@3.png',
                      ),
