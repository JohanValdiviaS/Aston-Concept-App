...
class VantageRoadsterF1 extends StatefulWidget {
  const VantageRoadsterF1({super.key});

  @override
  State<VantageRoadsterF1> createState() => _VantageRoadsterF1State();
}

class _VantageRoadsterF1State extends State<VantageRoadsterF1> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            FutureBuilder(
              future: noticiasF1.doc('VantageRoadsterF1').get(),
                ...
                return SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      // Img Auto
                      Image.network(
                        'https://configurator.api-services.astonmartin.com/static/assets/modelselection/am638f@4.png',
                      ),
