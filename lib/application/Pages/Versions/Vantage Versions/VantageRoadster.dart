...
class VantageRoadster extends StatefulWidget {
  const VantageRoadster({super.key});

  @override
  State<VantageRoadster> createState() => _VantageRoadsterState();
}

class _VantageRoadsterState extends State<VantageRoadster> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            FutureBuilder(
              future: noticiasF1.doc('VantageRoadster').get(),
              builder: (context, snapshot) {
                ...
                return Column(
                  children: [
                    ...
                    // Img Auto
                    Image.network(
                      'https://configurator.api-services.astonmartin.com/static/assets/modelselection/am638@3.png',
                    ),
