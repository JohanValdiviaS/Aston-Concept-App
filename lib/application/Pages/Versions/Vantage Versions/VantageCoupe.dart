...
class VantageCoupe extends StatefulWidget {
  const VantageCoupe({super.key});

  @override
  State<VantageCoupe> createState() => _VantageCoupeState();
}

class _VantageCoupeState extends State<VantageCoupe> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            FutureBuilder(
              future: noticiasF1.doc('VantageCoupe').get(),
              builder: (context, snapshot) {
                ...
                return Column(
                  children: [
                    ...
                    // Img Auto
                    Image.network(
                      'https://configurator.api-services.astonmartin.com/static/assets/modelselection/am608@3.png',
                    ),
