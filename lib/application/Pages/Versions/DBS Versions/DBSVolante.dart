...
class DBSVolante extends StatefulWidget {
  const DBSVolante({super.key});

  @override
  State<DBSVolante> createState() => _DBSVolanteState();
}

class _DBSVolanteState extends State<DBSVolante> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            FutureBuilder(
              future: noticiasF1.doc('DBSVolante').get(),
              builder: (context, snapshot) {
                ...
                return Column(
                  children: [
                    ...
                    // Img Auto
                    Image.network(
                      'https://configurator.api-services.astonmartin.com/static/assets/modelselection/am736@3.png',
                    ),
