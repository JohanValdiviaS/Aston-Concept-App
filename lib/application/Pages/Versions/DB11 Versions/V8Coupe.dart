...
class V8Coupe extends StatefulWidget {
  const V8Coupe({super.key});

  @override
  State<V8Coupe> createState() => _V8CoupeState();
}

class _V8CoupeState extends State<V8Coupe> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            FutureBuilder(
              future: noticiasF1.doc('DB11-V8Coupe').get(),
              builder: (context, snapshot) {
                ...
                return Column(
                  children: [
                    ...
                    // Img Auto
                    Image.network(
                      'https://configurator.api-services.astonmartin.com/static/assets/modelselection/am570@3.png',
                    ),
